		    ...
		    <div id="header">
					<div class="header-top">
						...
						<div class="search-header">
							<p>ようこそ<a href="#" class="">プリントphp</a>さん。<a href="./index.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></p>
				...
				<div class="category">
					<form method="get" action="#" class="header_form header_right" role="search">
						<!-- <div class="input-group category-input-group"> -->
							<!-- <input type="text" class="form-control center-block" width="100" placeholder="検索キーワード"> -->
						<span>
							<input type="text" class="form-control center-block"  placeholder="検索キーワード">
							<input type="submit" class="btn btn-default center-block" value="検索">
						</span>
						<!-- </div> -->
					</form>
				</div>
